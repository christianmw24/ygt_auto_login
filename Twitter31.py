...
class Twitter3(unittest.TestCase):
    def setUp(self):
    ...
    def test_twitter3(self):
        ...
        driver.find_element_by_link_text("daylin").click()
        driver.find_element_by_xpath("//div[@id='page-container']/div[3]/div/div[2]/div[2]/div/div[2]/div/div/ul/li[2]/a/span[3]").click()
